...
const SETS = {
  ...
  apocalypse_pact: {
    ...
    anathemas_gambit: {
    name: "Anathema's Gambit",
    code: "AG",
    date: "April 28, 2026",
    color: "#7b2d8b",
    ticketCards: ["Gildaria, Anathema of Attunement", "Adahime, Anathema of Death"],
    cards: [
      // ── FORESTCRAFT ──
      ["Macrobear",0,0,8,10711110],
      ["Elven Trapper",0,0,1,10711120],
      ["Cognitive Shift",0,0,1,10711310],
      ["Virewind Fencer",0,1,2,10712110],
      ["Hawkeyed Tactician",0,1,5,10712120],
      ["Minimized Anxiety",0,1,1,10712310],
      ["Frostbow Sniper",0,2,3,10713110],
      ["Magnified Malice",0,2,1,10713310],
      ["Thestae, Anathema of Distortion",0,3,4,10714110],
      ["Great Hart of the Glacial Realm",0,3,6,10714120],
      // ── SWORDCRAFT ──
      ["Bombastic Bombardier",1,0,3,10721110],
      ["High-Strung Liaison",1,0,3,10721120],
      ["Measured Attunement",1,0,1,10721310],
      ["Sharp-Eared Operative",1,1,2,10722110],
      ["Metronomic Medic",1,1,5,10722120],
      ["Orchestrated Silence",1,1,1,10722310],
      ["Knellclaw Lieutenant",1,2,5,10723110],
      ["Caesura al Fine",1,2,3,10723310],
      ["Gildaria, Anathema of Attunement",1,3,4,10724110],
      ["Cesar, Accordant Major",1,3,7,10724120],
      // ── RUNECRAFT ──
      ["Dainty Horror",2,0,4,10731110],
      ["Little Beastie",2,0,2,10731120],
      ["Heel, My Dearie",2,0,4,10731310],
      ["Charming Monster",2,1,3,10732110],
      ["Pretty Predator",2,1,2,10732120],
      ["Haphazard Snacking",2,1,2,10732310],
      ["Sweet Abomination",2,2,5,10733110],
      ["Bottomless Gluttony",2,2,4,10733310],
      ["Lilanthim, Anathema of Predation",2,3,7,10734110],
      ["Beloved Masterpiece",2,3,9,10734120],
      // ── DRAGONCRAFT ──
      ["Dragonewt Promoter",3,0,2,10741110],
      ["Carrier Wyvern",3,0,4,10741120],
      ["Apathetic Gaze",3,0,4,10741310],
      ["Gallant Gatekeeper",3,1,7,10742110],
      ["Draconic Part-Timer",3,1,2,10742120],
      ["Lazing Flame",3,1,3,10742310],
      ["Dragonewt Pathfinder",3,2,5,10743110],
      ["Blackflame Deluge",3,2,7,10743310],
      ["Burnite, Anathema of Ash",3,3,9,10744110],
      ["Dragon's Vale Elder",3,3,10,10744120],
      // ── ABYSSCRAFT ──
      ["Lulumi, Vamp on the Keys",4,0,2,10751110],
      ["Raz, Demon on the Drums",4,0,2,10751120],
      ["Soul Tuning",4,0,1,10751310],
      ["Highwire Feline",4,1,5,10752110],
      ["Juggler Corvid",4,1,6,10752120],
      ["Harmony of Youth",4,1,7,10752310],
      ["Beastmaster Bones",4,2,7,10753110],
      ["Hark to the Night Song",4,2,3,10753310],
      ["Adahime, Anathema of Death",4,3,6,10754110],
      ["Macmillan, Reaper of Ceremonies",4,3,9,10754120],
      // ── HAVENCRAFT ──
      ["Reverend of Finance",5,0,4,10761110],
      ["Missionary of Recruitment",5,0,6,10761120],
      ["Earrings of Sunlight",5,0,1,10761210],
      ["Sister of Strategic Development",5,1,2,10762110],
      ["Holy Hawk of Communications",5,1,8,10762120],
      ["Timepiece of Perfection",5,1,2,10762210],
      ["Deacon of Security",5,2,6,10763110],
      ["Trident of Eroding Tides",5,2,3,10763210],
      ["Rodeo, Anathema of Adjudication",5,3,8,10764110],
      ["Initia, Chief Ordination Officer",5,3,7,10764120],
      // ── PORTALCRAFT ──
      ["Brusque Barkeep",6,0,4,10771110],
      ["Beat Breaker",6,0,7,10771120],
      ["Freerunning",6,0,1,10771310],
      ["Cool Courier",6,1,2,10772110],
      ["Audacious Artist",6,1,6,10772120],
      ["Blink Step",6,1,2,10772310],
      ["Brazen Broadcaster",6,2,3,10773110],
      ["Warp Slash",6,2,3,10773310],
      ["Scarlet, Anathema of Dislocation",6,3,8,10774110],
      ["Myuu, Hot on His Heels",6,3,4,10774120],
      // ── NEUTRAL ──
      ["Altaro Superfan",7,0,2,10701110],
      ["Tears of Degradation",7,0,4,10701310],
      ["Intrepid Newshound",7,1,3,10702110],
      ["Hedonistic Socialite",7,2,3,10703110],
      ["City of Babelon",7,2,1,10703210],
